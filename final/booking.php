...
<body>
    ...
    echo "<script>const fareMatrix = " . json_encode($fareData) . ";</script>";
    ...
    <script>
        ...
        let selectedToda = ""; // New global variable to hold the selected TODA
        ...
        function displayPolygons() {
            dbPolygons.forEach((polygonData, index) => {
                ...
                polygon.toda = polygonData.toda; // This is where you assign the TODA
            });
        }
        ...
        function getShortestPath(pickup, dropoff) {
            ...
            axios.get(url)
                .then(response => {
                    ...
                    if (dropoffPoint) {
                        dropoffPoint
                            .bindPopup(`Drop-off Point<br>TODA: ${selectedToda}<br>Distance: ${distanceKm} km<br>ETA: ${etaMinutes} minutes<br>Fare: ₱${fare}`)
                            .openPopup();
                    }
